...
% dynamic BCs. k is pulled from separate function and stored as matrix.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
LHS = @(y,t) 0*sin(1*pi*t)+300;
RHS = @(y,t) 0*sin(.25*pi*t)+300;
BS = @(x,t) 0*sin(.5*pi*t)+300;
TS = @(x,t) 0*sin(.2*pi*t)+300;
IC = @(x,y,t) 200;
...
% Video parameters
vid_bool = 'ON';
video_name = '2D-plate-dyn-BC.avi';
% Video axis limits
tmin = 150;
tmax = 350;
